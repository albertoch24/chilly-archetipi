  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-accent-foreground font-semibold shadow-accent hover:brightness-95 hover:shadow-elevated hover:scale-[1.02] active:scale-[0.98]",
        heroOutline: "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground",
        quiz: "bg-card text-card-foreground border border-border hover:border-accent hover:shadow-medium",
        quizSelected: "bg-accent/10 text-foreground border-2 border-accent shadow-soft",
        admin: "bg-primary text-primary-foreground hover:bg-primary/90",
        flag: "bg-success text-success-foreground hover:bg-success/90 shadow-soft",
      },
      size: {
